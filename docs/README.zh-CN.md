...
首次管理员账号的创建方式见 [账号初始化](account-bootstrap.md)。
...
完整部署说明见 [部署文档](deployment.md)。

## 许可证

源代码和文档采用 [MIT License](../LICENSE)。由 GPT 生成的 Inventory Art logo
及其派生应用图标单独采用 CC BY 4.0，详见[素材授权说明](../ASSETS.md)。
...
- [安全与租户隔离](security-and-tenancy.md)
- [部署](deployment.md)
- [商品图片存储](r2-storage.md)
- [账号初始化](account-bootstrap.md)
