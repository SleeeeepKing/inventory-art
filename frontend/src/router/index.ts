  ...
  },
  {
    ...
    children: [
      { path: '', redirect: '/dashboard' },
      {
        ...
        meta: { titleKey: 'nav.dashboard', userOnly: true },
      },
      {
        path: 'products',
        name: 'products',
        component: () => import('@/views/ProductsView.vue'),
        meta: { titleKey: 'nav.products', userOnly: true },
      },
      {
        path: 'inventory',
        name: 'inventory',
        component: () => import('@/views/InventoryView.vue'),
        meta: { titleKey: 'nav.inventory', userOnly: true },
      },
      {
        path: 'orders',
        name: 'orders',
        component: () => import('@/views/OrdersView.vue'),
        meta: { titleKey: 'nav.orders', userOnly: true },
      },
      {
        path: 'events',
        name: 'events',
      ...
      },
      {
        ...
        meta: { titleKey: 'nav.tenants', adminOnly: true },
      },
      {
        path: 'admin/users',
        name: 'admin-users',
