export const en = {
  ...
  inventory: {
    ...
    title: 'Inventory',
    subtitle: 'Manage every stock change here, independently from orders and sales imports.',
    adjust: 'Adjust stock',
    sell: 'Sell',
    stockIn: 'Add stock',
    ...
    stockUnchanged: 'Enter a quantity different from the current stock.',
    recordSale: 'Record sold products',
    stockAdded: 'Stock added.',
    saleRecorded: 'Inventory sale recorded.',
    soldProducts: 'Sold products',
    actualPrice: 'Actual unit price',
    ...
    emptyBody: 'Make the first stock adjustment to begin the ledger.',
    movementTypes: {
      ...
      STOCK_CORRECTION: 'Exact stock correction',
  ...
  orders: {
    ...
    selectEvent: 'Select an exhibition or event',
    manageEvents: 'Manage exhibitions',
    addEvent: 'Add exhibition',
    editEvent: 'Edit exhibition',
    eventDates: 'Dates',
    ...
    batchRecorded: '{count} orders recorded.',
    selectedCount: '{count} selected',
    batchConfirm: 'Confirm selected',
    batchCancel: 'Cancel selected',
    batchConfirmTitle: 'Confirm selected draft orders?',
    batchConfirmBody: '{count} draft orders will be confirmed.',
    batchCancelTitle: 'Cancel selected orders?',
    batchCancelBody: '{count} orders will be cancelled. Inventory will not change.',
    batchSucceeded: '{count} orders processed successfully.',
    batchPartial: '{succeeded} succeeded and {failed} failed.',
    batchFailures: 'Orders that could not be processed',
    source: 'Source',
    notes: 'Notes',
    items: 'Order items',
    itemsOptional: 'Optional',
    itemsHint: 'Add products only when you want to record which items and quantities were sold.',
    noItems: 'No products recorded for this order.',
    addItem: 'Add item',
    product: 'Product',
    quantity: 'Qty',
    ...
    refundBody: 'The refund will be recorded without changing inventory.',
    confirmTitle: 'Confirm this order?',
    confirmBody: 'The order will be confirmed without changing inventory.',
    cancelTitle: 'Cancel this order?',
    cancelBody: 'The order will be cancelled without changing inventory.',
  ...
  events: {
    ...
    endDate: 'End date',
    schedule: 'Schedule',
    total: 'All exhibitions',
    enabledCount: 'Enabled',
    upcomingCount: 'Current & upcoming',
    days: '{count}-day run',
  ...
  import: {
    ...
    subtitle: 'Review every row before it creates sales records. Imports never change inventory.',
  ...
  errors: {
    ...
    orderItemsRequired: 'Add at least one item to the order.',
    orderAlreadyCancelled: 'This order has already been cancelled.',
    orderCannotBeCancelled: 'This order can no longer be cancelled.',
    orderNotEditable: 'This order can no longer be edited.',
    invalidDiscount: 'The discount cannot exceed the line amount.',
