...
public class ExternalProductMapping {
  ...
  @Column(name = "external_product_reference")
  private String externalProductReference;

  @Column(name = "external_product_name")
  private String externalProductName;

  @Column(name = "normalized_external_name", nullable = false)
  private String normalizedExternalName;
  ...
  static ExternalProductMapping create(
      UUID tenantId, String reference, String name, UUID productId, UUID userId) {
    ...
    mapping.normalizedExternalName =
        SumUpNormalizer.normalizeText(name == null || name.isBlank() ? reference : name);
