...
public class ExternalTransactionController {
  ...
  public PageResponse<ExternalTransactionDtos.Response> list(
    ...
    return PageResponse.of(
        transactions
            .search(currentUser.tenantId(), status, from(from), to(to), pageable)
  ...
  public List<ExternalTransactionDtos.OrderMatch> matches(@PathVariable UUID id) {
    return links.matches(id);
  }

  @PostMapping("/{id}/link-order")
  public ExternalTransactionDtos.Response link(
      @PathVariable UUID id, @Valid @RequestBody ExternalTransactionDtos.LinkOrderRequest request) {
