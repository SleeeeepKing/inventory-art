...
public class ImportRow {
  ...
  private ImportRowStatus processingStatus;
  ...
  @JdbcTypeCode(SqlTypes.JSON)
  @Column(name = "sanitized_raw_data", columnDefinition = "jsonb", nullable = false)
  ...
  void linkProduct(UUID productId) {
    this.linkedProductId = productId;
  }
  ...
  public ImportRowStatus getProcessingStatus() {
  ...
  public Map<String, Object> getNormalizedData() {
    return normalizedData;
  }

  public Map<String, Object> getSanitizedRawData() {
  ...
  public UUID getLinkedProductId() {
