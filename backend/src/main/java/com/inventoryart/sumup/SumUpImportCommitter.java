...
/**
 * Transaction boundary between the file-analysis and order modules. Implementations make row,
 * transaction, and order writes atomically and idempotently. Inventory is intentionally outside
 * this boundary.
 */
