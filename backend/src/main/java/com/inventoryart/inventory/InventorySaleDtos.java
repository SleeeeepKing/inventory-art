...
public final class InventorySaleDtos {
    ...
    public record SaleRequest(@NotNull SalesChannel salesChannel, UUID eventId,
    ...
    public record SaleResponse(UUID id, String salesChannel, UUID eventId, String eventName,
                               String currency, LocalDate attributedDate, String remark,
                               UUID operatorId, Instant createdAt,
