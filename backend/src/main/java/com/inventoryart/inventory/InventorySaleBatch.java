...
public class InventorySaleBatch {
    ...
    @Column(name = "attributed_date", nullable = false) private LocalDate attributedDate;
    ...
    public InventorySaleBatch(UUID tenantId, SalesChannel salesChannel, UUID eventId, String eventName,
                              String currency, LocalDate attributedDate, String remark, UUID operatorId) {
    ...
    public LocalDate getAttributedDate() { return attributedDate; }
