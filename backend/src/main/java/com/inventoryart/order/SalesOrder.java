...
public class SalesOrder {
    ...
    public SalesOrder(UUID id,UUID tenant,String number,OrderSource source,OrderStatus status,AllocationStatus allocation,SalesChannel channel,UUID eventId,String event,String customerName,String customerEmail,String note,String currency,PaymentMethod method,PaymentStatus paymentStatus,Instant date,UUID createdBy){
        this.id=id;this.tenantId=tenant;this.orderNumber=number;this.source=source;this.status=status;this.allocationStatus=allocation;this.salesChannel=channel;this.eventId=eventId;this.eventName=event;this.customerName=customerName;this.customerEmail=customerEmail;this.customerNote=note;this.currency=currency;
    ...
    public void updateDetails(SalesChannel channel,UUID eventId,String event,String name,String email,String note,PaymentMethod method,PaymentStatus paymentStatus,Instant date){this.salesChannel=channel;this.eventId=eventId;this.eventName=event;this.customerName=name;this.customerEmail=email;this.customerNote=note;this.paymentMethod=method;this.paymentStatus=paymentStatus;this.orderDate=date;this.manuallyModifiedAfterImport=source==OrderSource.SUMUP_IMPORT;this.updatedAt=Instant.now();}
    public void confirmed(){this.status=OrderStatus.CONFIRMED;this.updatedAt=Instant.now();}
