...
public class SalesOrder {
  ...
  @Column(name = "manually_modified_after_import", nullable = false)
  private boolean manuallyModifiedAfterImport;
  ...
  public boolean isManuallyModifiedAfterImport() {
    return manuallyModifiedAfterImport;
  }
  ...
  public void setAmounts(
    ...
    this.unallocatedAmount = unallocated;
  ...
  public void updateDetails(
    ...
    this.paymentStatus = paymentStatus;
    this.orderDate = date;
    this.manuallyModifiedAfterImport = source == OrderSource.SUMUP_IMPORT;
    this.updatedAt = Instant.now();
  }
  ...
  public void setExternal(
      String provider, String transactionId, UUID batchId, BigDecimal unallocated) {
