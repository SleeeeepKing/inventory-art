...
public class ReportController {
    ...
    public ReportController(ReportService reports, InventorySalesReportService inventorySales, AuditService audit) { this.reports = reports; this.inventorySales = inventorySales; this.audit = audit; }
    ...
    public ReportDtos.InventorySalesReport adminInventorySales(
        ...
        audit.record(tenantId, "ADMIN_INVENTORY_REPORT_READ", "REPORT", null, "SUCCESS",
            java.util.Map.of("start", String.valueOf(start), "end", String.valueOf(end)));
        return report;
    }
}
