...
/**
 * Provider-neutral private object storage. Object keys, never provider URLs, are
...
public interface StorageService extends AutoCloseable {
    ...
    PresignedRequest presignPut(String objectKey, String contentType, long contentLength,
